...
class HashtagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post hashtags_url, params: { hashtag: { post_id: @hashtag.post_id, title: @hashtag.title } }
    end
  ...
  test "should update hashtag" do
    patch hashtag_url(@hashtag), params: { hashtag: { post_id: @hashtag.post_id, title: @hashtag.title } }
